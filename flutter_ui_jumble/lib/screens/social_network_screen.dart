...
class _SocialNetworkScreenState extends State<SocialNetworkScreen> {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: [
          ...
          BottomNavigationBarItem(
              icon: Icon(Icons.search, color: Colors.grey[400]), label: ''),
          BottomNavigationBarItem(
              icon: Icon(Icons.person, color: Colors.grey[400]), label: '')
        ],
      ),
      body: SafeArea(
        ...
        child: ListView(
          children: [
            ...
            _makeSingleOfficialNews(
                '30min', 'Here is the latest news for you✋'),
            _makeSingleTweet(
                'username',
                'P',
                Colors.black,
            ...
            _makeSingleTweet(
                ...
                true),
            _makeSingleTweet('username', 'D', Colors.black, '2h・@accountid3',
                'Lorem ipsum dolor sit amet', true),
            _makeSingleTweet('username', 'T', Colors.red, '4h・@accountid4',
                'Lorem ipsum dolor sit amet', false),
            _makeSingleTweet('username', 'U', Colors.black,
                'yesterday・@accountid5', 'Lorem ipsum dolor sit amet', false),
          ],
        ),
      )),
    );
  ...
  Widget _makeSingleTweet(String username, String initial, Color color,
      String account, String body, bool hasLink) {
    return Container(
